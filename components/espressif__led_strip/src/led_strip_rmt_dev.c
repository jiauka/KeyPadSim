...
static esp_err_t led_strip_rmt_refresh(led_strip_t* strip)
{
  ...
  ESP_RETURN_ON_ERROR(
    rmt_transmit(rmt_strip->rmt_chan, rmt_strip->strip_encoder, rmt_strip->pixel_buf, rmt_strip->strip_len * rmt_strip->bytes_per_pixel, &tx_conf), TAG, "transmit pixels by RMT failed");
...
esp_err_t led_strip_new_rmt_device(const led_strip_config_t* led_config, const led_strip_rmt_config_t* rmt_config, led_strip_handle_t* ret_strip)
{
  ...
  led_strip_encoder_config_t strip_encoder_conf = { .resolution = resolution, .led_model = led_config->led_model };
